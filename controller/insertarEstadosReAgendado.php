	...
	if($result->num_rows > 0){
		while ($row = $result->fetch_assoc()) {
			...
			$insert = "INSERT INTO bitacoracopia (usuario,fecha,modulo,accion,identificador,sentencia) VALUES
			  ('".$usuario."','".$fechaSol." 08:00:00','Solicitudes','Fue actualizado un registro en Solicitud con el id #".$idsolicitud.". <br/><ul><li>El campo <b>Estado</b> fue modificado. Valor nuevo: ReAgendado.</li></ul>',".$idsolicitud.",'UPDATE solicitudes SET estatus =  7  WHERE id =  ".$idsolicitud." - Ajuste ')";
			  echo "INSERT:".$insert;
					$mysqli->query($insert);     
			} 
