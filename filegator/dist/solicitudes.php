...
if (! file_exists(__DIR__.'/../configuration_solicitudes.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_solicitudes.php');
}
...
$config = require __DIR__.'/../configuration_solicitudes.php';
