<?php
	...
	bitacora('Beneficiario', 'Solicitud de interface listado de beneficiarios', 0, '');
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Beneficiarios - Senadis</title>
    <!-- Favicon icon -->
	...
	<!-- Bootstrap CSS -->
	<link rel="stylesheet" href="menualt/css/bootstrap.min.css">
	<!-- Typography CSS -->
	<link rel="stylesheet" href="menualt/css/typography.css">
	<!-- Style CSS -->
	<link rel="stylesheet" href="menualt/css/style.css">
	<!-- Responsive CSS -->
	<link rel="stylesheet" href="menualt/css/responsive.css">
</head>
...
<body>
            ...
            <div class="container-fluid pt-0">                
				<div class="row">
					<div class="col-md-12 mb-3 text-right">
					    <button type="button" class="btn btn-primary btn-xs" id="nuevoBeneficiario">
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="table-responsive">
							<table id="tablabeneficiarios" class="display min-w850">
								<thead>
									<tr>
										<th>Acciones</th>
										<th id="theadid">ID</th>
										...
										<th id="csexo">Sexo</th>
										<th id="cfecha_nac">Fecha de Nacimiento</th>
										<th id="cdiscapacidades">Discapacidad</th>
									</tr>
								</thead>
								<tbody></tbody>
							</table>
    ...
    ***********************************-->
	...
	<script src="menualt/js/popper.min.js"></script>
	<script src="menualt/js/jquery.min.js"></script>
	<script src="menualt/js/bootstrap.min.js"></script>
	<!-- Smooth Scrollbar JavaScript -->
	<script src="menualt/js/smooth-scrollbar.js"></script>
	<!-- Chart Custom JavaScript -->
	<script src="menualt/js/chart-custom.js"></script>
	<!-- Custom JavaScript -->
	<script src="menualt/js/custom.js"></script>
    <?php linksfooter(); ?>
    <!-- Datatable -->
    ...
    <!-- <script src="./js/beneficiarios-exportar.js?<?php autoVersiones(); ?>"></script>	 -->
</body>
