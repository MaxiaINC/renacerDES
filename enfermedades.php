<?php
	...
	//bitacora('Condición de salud', 'Solicitud de interface listado de Condición de salud', 0, '');
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
            ...
            <div class="container-fluid pt-0">                
				<div class="row">
					<div class="col-md-12 mb-3 text-right">
					    <button type="button" class="btn btn-primary btn-xs" id="nuevaEnfermedad">
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="table-responsive">
							<table id="tablaenfermedades" class="display min-w850">
								<thead>
									<tr>
										<th>Acciones</th>
										<th id="cid">ID</th>
    ...
    ***********************************-->
    ...
    <!-- <script src="./js/Enfermedades-exportar.js?<?php autoVersiones(); ?>"></script>	 -->
</body>
