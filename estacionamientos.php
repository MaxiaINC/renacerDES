...
<head>
    ...
    <title>Solicitudes de permiso de estacionamiento - Senadis</title>
    <!-- Favicon icon -->
...
<body>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                Solicitudes de permiso de estacionamiento
                            </div>
                        </div>
    ...
    ***********************************-->
    <?php linksfooter(); ?>
	<!-- Solicitudes -->
    <script src="./js/estacionamientos.js?<?php autoVersiones(); ?>"></script>	
</body>
