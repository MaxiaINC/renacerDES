            ...
            <div class="container-fluid pt-0">
				<div class="row">
                    <div class="col-md-12 mb-4 text-right barraOpc">
                        <button type="button" class="btn btn-primary btn-xs" id="listadoNiveles">
								...
								<form id="form_nivel">
									<div class="row">
										...
										<div class="form-group col-12">
											...
											<input type="hidden" class="form-control" name="idnivel" id="idnivel">
										...
										<div class="form-group col-12 col-sm-6 col-md-3">
											...
											<select lang="es" class="form-control mandatorio" name="estado" id="estado" autocomplete="off">	  
