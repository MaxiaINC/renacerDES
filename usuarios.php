<?php
	...
	//BITACORA
	//bitacora($_SESSION['usuario_sen'], 'Seguridad', 'Solicitud de interface listado de usuarios', 0, '');
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
            ...
            <div class="container-fluid pt-0">                
				<div class="row">
					<div class="col-md-12 mb-3 text-right">
					    <button type="button" class="btn btn-primary btn-xs" id="nuevoUsuario">
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="table-responsive">
							<table id="tablausuarios" class="display min-w850">
								<thead>
									<tr>
										<th>Acciones</th>
										<th id="theadid">ID</th>
										...
										<th id="ccargo">Cargo</th>  
										<th id="cnivel">Nivel</th>
    ...
    ***********************************-->
    ...
    <!-- <script src="./js/usuarios-exportar.js?<?php autoVersiones(); ?>"></script>	 -->
</body>
