<?php
	...
	//BITACORA
    //bitacora('Solicitudes', 'Obtener listado de solicitudes', '', '');
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Solicitudes - Senadis</title>
    <!-- Favicon icon -->
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
            ...
            <div class="container-fluid pt-0">                
				<div class="row">
					<div class="col-md-12 mb-3 text-right">
                        ...
                        <!--<button type="button" class="btn btn-primary btn-xs" id="firma">
							<i class="fa fa-plus-circle mr-2"></i> Firma
						</button>-->
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="table-responsive">
							<table id="tablasolicitudes" class="display min-w850">
								<thead>
									<tr>
										<th>Acciones</th>
                                        ...
                                        <th id="cfecha_cita">Fecha de cita</th>
                                        <th id="cregional">Regional</th>
                                        <th id="cestatus">Estado</th>
		...
		<?php include_once('solicitud-agendamiento.php'); ?>
		<?php include_once('solicitud-emitir-resolucion.php'); ?>
		<?php include_once('solicitud-emitir-negatoria.php'); ?>
		<?php include_once('solicitud-adjuntos.php'); ?>
    </div>
    <!--**********************************
            Content body end
        ***********************************-->
    ...
    ***********************************-->
    <?php linksfooter(); ?>
	<!-- Solicitudes -->
    <script src="./js/solicitudes.js?<?php autoVersiones(); ?>"></script>	
</body>
