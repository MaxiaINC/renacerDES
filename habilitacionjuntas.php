...
<body>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="table-responsive">
							<table id="tablahabilitacionjuntas" class="display min-w850">
								<thead>
									<tr>
										<th>Acciones</th>
                                        <th>ID</th>
                                        <th id="cnroresolucion">N° de resolución</th>
                                        <th id="cnrojunta">N° de junta</th>
    ...
    ***********************************-->
    <?php linksfooter(); ?>
	<!-- Auditorias -->
    <script src="./js/habilitacionjuntas.js?<?php autoVersiones(); ?>"></script>	
</body>
