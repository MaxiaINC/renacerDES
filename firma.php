...
<body>
								...
								<form id="form_nivel">
									<div class="row">
										...
										<div class="form-group col-6">
											...
											<select lang="es" class="form-control mandatorio" name="cargo" id="cargo" autocomplete="off">
											    <option value=""></option>
											    <option value="Director(a) General">Director(a) General</option>
											    <option value="Dir. Nal. de Certificaciones">Dir. Nal. de Certificaciones</option>
											    <option value="Director(a) General Encargado">Director(a) General Encargado</option>
											    <option value="Dir. Nal. de Certificaciones Encargado">Dir. Nal. de Certificaciones Encargado</option>
											</select>
										</div> 
									
									<div class="col-sm-12">
										<h5 class="col-form-label text-success">Haga clic en el recuadro para agregar la firma</h5>
									</div>
									<div class="container mt-2">
                                        <div class="group groupfirma">
                                            <img src="" alt="" class="crop-image" id="crop-image">
    ...
    ***********************************-->
    ...
    <script src="./js/firma.js<?php autoVersiones(); ?>"></script>	
    <script src="./js/firma-cropper.js<?php autoVersiones(); ?>"></script>	
</body>
