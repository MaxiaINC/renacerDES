...
if (! file_exists(__DIR__.'/../configuration_auditorias.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_auditorias.php');
}
...
$config = require __DIR__.'/../configuration_auditorias.php';
