<?php
	...
	//bitacora('Niveles', 'Solicitud de interface listado de niveles', 0, '');
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Códigos de autorización para reimpresión - Senadis</title>
    <!-- Favicon icon -->
...
<body>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                Códigos de autorización para reimpresión
                            </div>
                        </div>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="table-responsive">
							<table id="tabla" class="display min-w850">
								<thead>
									<tr>
										<th>Acciones</th>
										<th id="theadid">ID</th>
    ...
    ***********************************-->
	...
	<!-- Niveles -->
    <script src="./js/codigosautorizacion.js?<?php autoVersiones(); ?>"></script>
    <!-- <script src="./js/niveles-exportar.js?<?php autoVersiones(); ?>"></script>	 -->
</body>
